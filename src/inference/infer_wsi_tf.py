...
def main(slide_path: str, config_path: str, output_dir: str):
    ...
    patch_infos = extract_patches_from_wsi(
        ...
        patient_id_hint=slide_path.stem,
    )
    ...
    with tf.device(device_str):
        ...
        print("Probabilidades por estágio:", dict(zip(cfg.class_names, mean_proba.tolist())))
